"""
Django settings for AkashCodingSchool project.
...
SECRET_KEY = 'django-insecure-7_p&7o5pu!klj-v^79qo5^^-%n_96$-=uvflv8hz!0il@z+$mr'
...
WSGI_APPLICATION = 'AkashCodingSchool.wsgi.application'
